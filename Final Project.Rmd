...
sum(is.na(car_price_data$emission_class))  # Number of rows with missing emission_class
validation_data <- car_price_data[is.na(car_price_data$emission_class) & 
                                  rowSums(is.na(car_price_data)) == 1, ]
...
sum(is.na(pred_validation))  # Count of missing predicted values
sum(is.na(validation_data$price))  # Count of missing actual values
