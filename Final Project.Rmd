...
[Note: based off of this correlation map:
- Remove one of views/favourites since this has strong correlation (but I think we're getting rid of both anyways)
- Ensure no multicollinearity between horsepower and engine_capacity (VIF?)
- Check to see if we can remove seats_amount and car_mileage from the model since they don't give much information on price it looks like
  - this is just a little suspicious since usually more mileage should mean cheaper car? just make sure to do lots of investigation before removing it.]
